...
-- Table `irs`.`employee`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `irs`.`employee` ;

CREATE  TABLE IF NOT EXISTS `irs`.`employee` (
...
-- -----------------------------------------------------
-- Table `irs`.`employee_investor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `irs`.`employee_investor` ;

CREATE  TABLE IF NOT EXISTS `irs`.`employee_investor` (
  `employee_id` INT NOT NULL ,
  `investor_id` INT NOT NULL ,
  INDEX `investor_id_idx` (`investor_id` ASC) )
ENGINE = InnoDB;

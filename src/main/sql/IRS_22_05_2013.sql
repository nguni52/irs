...
CREATE  TABLE IF NOT EXISTS `irs`.`title` (
  ...
  `title_description` VARCHAR(4) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `irs`.`person` (
  ...
  `work_number` VARCHAR(45) NULL DEFAULT NULL ,
...
-- Table `irs`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `irs`.`role` ;

CREATE  TABLE IF NOT EXISTS `irs`.`role` (
...
CREATE  TABLE IF NOT EXISTS `irs`.`investor` (
  ...
  `investor_description` VARCHAR(45) NULL DEFAULT NULL ,
...
CREATE  TABLE IF NOT EXISTS `irs`.`physical_address` (
  ...
  `investor_id` INT NULL ,
  `unit number` INT NULL DEFAULT NULL ,
  ...
  `status` TINYINT NOT NULL ,
  `asset_manager_id` VARCHAR(45) NULL ,

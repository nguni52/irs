...
<section id="main">
    <article class="type-page">
        <header>
            <h1>
                <h1>Add an Asset Manager</h1>
            </h1>
        </header>
        <form id="addassetmanager" method="POST" name="addassetmanager" action="<%=request.getContextPath()%>/admin/assetmanager/addassetmanager">
            <fieldset>
                <legend>Asset Manager Details</legend>
                <label>Description:</label><input type="text" name="description" id="description" class="required" minlength="1" maxlength="45" /><br />
                ...
                <label>Email Address:</label><input type="email" name="assetmanageremailaddress" id="assetmanageremailaddress" class="required" minlength="6" maxlength="45" /><br />
            </fieldset>
            ...
            <label>&nbsp;</label><input type="submit" value="Add Asset Manager">
